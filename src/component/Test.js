...
const Test = () => {
  ...
  return (
    <div className="w-screen h-screen px-[30px] py-[100px] bg-white overflow-hidden">
      ...
      <div className="bg-white w-full h-full relative rounded-xl">
        <motion.div
          className="timer w-[100px] flex h-[100px] rounded-[50%] absolute left-[50%] top-0 border-purple-400 border-[5px] bg-white translate-x-[-50%] translate-y-[-50%]  z-[1000]"
